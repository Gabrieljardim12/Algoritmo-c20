...
function draw() {
  ...
  if(retanguloMovel.x - retanguloFixo.x < retanguloFixo.width/2 + retanguloMovel.width/2
    ...
    && retanguloFixo.y - retanguloMovel.y < retanguloFixo.height/2 + retanguloMovel.height/2 &&
     retanguloMovel.y - retanguloFixo.y < retanguloFixo.height/2 + retanguloMovel.height/2){
